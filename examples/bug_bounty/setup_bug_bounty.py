...
def print_quick_start():
    ...
    print("3. Create scope configuration:")
    print("   python autonomous_controller.py --create-template")
    print("4. Edit bug_bounty_scope.yaml with your target details")
    print("5. Run autonomous hunt:")
    print("   python autonomous_controller.py --config bug_bounty_scope.yaml")
    print("\n🎯 Alternative Quick Testing:")
    print("   python bug_bounty_workflow.py example.com quick")
    print("   python bug_bounty_workflow.py example.com full")
    print("   python simple_example.py")
    print("\n📚 Documentation:")
    print("   - CAI Framework: https://github.com/aliasrobotics/cai")
    print("   - Autonomous Guide: AUTONOMOUS_README.md")
